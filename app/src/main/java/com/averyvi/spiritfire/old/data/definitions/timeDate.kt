package com.averyvi.spiritfire.old.data.definitions
...
data class ResetDaysInterval(
    ...
    companion object {
        val DAILY =
            ResetDaysInterval(
                interval_unit = ResetDaysIntervalUnit.DAILY,
                interval_value = ""
            )
        val WEEKLY =
            ResetDaysInterval(
                interval_unit = ResetDaysIntervalUnit.WEEKLY,
                interval_value = ""
            )
        val MOTHLY =
            ResetDaysInterval(
                interval_unit = ResetDaysIntervalUnit.MONTHLY,
                interval_value = ""
            )
        val YEARLY =
            ResetDaysInterval(
                interval_unit = ResetDaysIntervalUnit.YEARLY,
                interval_value = ""
            )
        val EVERYOTHER =
            ResetDaysInterval(
                interval_unit = ResetDaysIntervalUnit.CUSTOM_DAYS,
                interval_value = "2"
            )
        val THREE =
            ResetDaysInterval(
